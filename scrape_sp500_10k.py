...
Automatically fetches current S&P 500 companies and scrapes their 10-K filings
from the last 5 years, saving parsed text to CSV.
"""
...
OUTPUT_DIR = "/home/user/Case-2/sp500_10k_output"
...
if __name__ == "__main__":
    # Run the scraper
    # To test with just a few companies, use: main(max_companies=5)
    # To scrape all S&P 500 companies, use: main()
    main()
